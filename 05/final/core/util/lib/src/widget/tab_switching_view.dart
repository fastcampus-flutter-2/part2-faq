...
class CoreTabSwitchingView extends StatefulWidget {
  const CoreTabSwitchingView({
  ...
  @override
  State<CoreTabSwitchingView> createState() => _CoreTabSwitchingViewState();
}

class _CoreTabSwitchingViewState extends State<CoreTabSwitchingView> {
  ...
  @override
  void didUpdateWidget(CoreTabSwitchingView oldWidget) {
      ...
      if (tabFocusNodes.length > widget.tabCount) {
        ...
        tabFocusNodes.addAll(
          List<FocusScopeNode>.generate(
            ...
            (int index) => FocusScopeNode(debugLabel: '$CoreTabSwitchingView Tab ${index + tabFocusNodes.length}'),
          ),
        );
      }
    }
