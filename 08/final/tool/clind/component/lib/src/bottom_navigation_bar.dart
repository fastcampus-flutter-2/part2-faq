  ...
  Widget build(BuildContext context) {
    ...
    if (isSelected) {
      return switch (type) {
        ...
        ClindNavigationType.popular => ClindIcon.homeOn(color: color),
        ClindNavigationType.write => ClindIcon.edit(color: color),
    ...
    return switch (type) {
      ...
      ClindNavigationType.popular => ClindIcon.homeOff(color: color),
      ClindNavigationType.write => ClindIcon.edit(color: color),
