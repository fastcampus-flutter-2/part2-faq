    ...
    return FlowMultiRepositoryProvider(
      providers: [
        FlowRepositoryProvider<IPostRemoteDataSource>(
          create: (context) => PostRemoteDataSource(MockPostApi(Modular.get<ClindRestClient>())),
        ),
        FlowRepositoryProvider<IProfileRemoteDataSource>(
          create: (context) => ProfileRemoteDataSource(MockProfileApi(Modular.get<ClindRestClient>())),
        ),
      ],
