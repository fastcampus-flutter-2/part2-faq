        ...
        data: (context, state) => CoreTabSwitchingView(
          ...
          tabBuilder: (context, index) {
            final Widget screen = switch (index) {
              0 => ICommunityRoutes.find(Uri(path: CommunityRoute.community.path)),
              1 => INotificationRoutes.find(Uri(path: NotificationRoute.notification.path)),
              2 => IMyRoutes.find(Uri(path: MyRoute.my.path)),
              _ => IClindRoutes.find(Uri(path: ClindRoute.unknown.path)),
            };
            return screen;
          },
        ),
